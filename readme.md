...
I started with creating the needed files for the project (the folders, app.js, index.ejs, etc). Then I installed the needed modules for the chat. After that I created some JS files and hoped everything would work. And it did. It also makes your text looks like you were crying while you were typing.
